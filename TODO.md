...
- [~] 补齐目标市场：日✅ / 韩 / 繁中✅ / 越 / 泰 / 马来 / 印尼 / 西 / 葡(巴) / 阿拉伯
      进度：**繁体中文 + 日本語 均已 100% 补齐**。
      - 繁中（台湾/香港）+207 键（台湾用词：方案/餘額/點數/裝置/設定/登入/帳號…）
      - 日本語 +207 键（ビジネス日本語：プランと残高/チャージ/クレジット/デバイス/設定/ログイン…）
      两者均 e2e 截图确认团队/导航等全本地化无英文回落。
      其余 8 语（韩/越/泰/马来/印尼/西/葡(巴)/阿拉伯）仍缺 ~185 键，逐语言补齐、非中日语建议母语校对
