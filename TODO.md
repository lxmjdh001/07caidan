...
- [~] 补齐目标市场：日 / 韩 / 繁中 / 越 / 泰 / 马来 / 印尼 / 西 / 葡(巴) / 阿拉伯
      ⚠️ 实测仅约 15% 完成：各非英文字典缺 ~160-200/222 键（后续新增的 campaign/billing/team/
      settings/support/device 等功能未译，运行时回落英文）。RTL 校对时发现底部导航半中半英即此因。
      建议后续按「导航/设置/认证等高频 chrome 键」优先补齐，需母语校对；键已接好，只差译文
